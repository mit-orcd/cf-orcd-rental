...
When AUTO_DEFAULT_PROJECT_ENABLE is True, new users get a USERNAME_default_project.
...
def auto_configure_user(sender, instance, created, **kwargs):
    ...
    # Auto Default Project: create USERNAME_default_project
...
def create_default_project_for_user(user):
    ...
    The project is named USERNAME_default_project.
    ...
    project_title = f"{user.username}_default_project"
